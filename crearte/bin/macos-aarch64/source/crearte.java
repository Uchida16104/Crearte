/* autogenerated by Processing revision 1304 on 2025-06-25 */
...
public class crearte extends PApplet {
...
public void setup() {
  ...
  if (audio == null) {
    ...
    pg.beginDraw();
    pg.imageMode(CENTER);
    spectrogram.resize((int)(canvasW * 0.8f), (int)(specHeight * 0.5f));
    int x = canvasW / 2;
...
public void addTempoAndTimeSignature(Sequence seq) {
  try {
...
public float customPolarRadius(float angle, float baseRadius) {
  return baseRadius + tan(angle * 4) * 5 + tan(angle * 2.5f) * 3;
}
public void drawPolarStaffs(PGraphics g) {
...
public void drawPolarNotes(PGraphics g) {
  g.strokeWeight(1);
...
public void addExpressionAndInstruments(Sequence seq) {
  try {
    Track[] tracks = seq.getTracks();
    for (int t = 0; t < tracks.length; t++) {
...
public void stop() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "crearte" };
    if (passedArgs != null) {
